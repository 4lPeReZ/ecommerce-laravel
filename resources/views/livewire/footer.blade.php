{{-- Nuestro footer con diseño responsive --}}
<footer class="text-center bg-backgroundfooter text-fondo">
    <div class="container px-6 pt-6">
        <div class="grid lg:grid-cols-3 md:grid-cols-1">
            <div class="mb-6">
                <h5 class="font-semibold mb-2.5">Ponte en contacto con nosotros</h5>

                <ul class="list-none mb-0">
                    <li>
                        <a class="text-footerprincipal hover:no-underline">Avenida Ana de Viya, 20</a>
                    </li>
                    <li>
                        <a class="text-footerprincipal hover:no-underline">11011, Cádiz</a>
                    </li>
                    <li>
                        <a class="text-footerprincipal hover:no-underline">España</a>
                    </li>
                    <li>
                        <a class="text-footerprincipal hover:no-underline">info.kshop@gmail.com</a>
                    </li>
                </ul>
            </div>

            <div class="mb-6">
                <h5 class="font-semibold mb-2.5">Links</h5>
    ...
    <div class="text-center p-4 text-fondo bg-backgroundfooter">
        Derechos de autor 2022, K-Shop
    </div>
</footer>
