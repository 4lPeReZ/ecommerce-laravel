{{-- Componente que pertenece a nuestra buscador y nos devuelve el resultado --}}
<div class="flex-1 relative font-roboto_reg" x-data>

    <form action="{{ route('search') }}" autocomplete="off">
        <x-jet-input class="font-roboto_reg w-[22rem] sm:w-full" name='name' wire:model="search" type="text"
